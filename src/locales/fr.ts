export default {
  ...
  about: {
    ...
    p1: "Je suis un étudiant en Génie Logiciel à l'Université d'Ottawa, au Canada. 🇨🇦",
    ...
    content: [
      {
        ...
        tags: ["Go", "Docker", "Bash", "Kafka", "Redis"],
        img: "tesla",
    ...
    content: [
      {
        ...
        devpost: "https://devpost.com/software/microvisor",
        tags: ["Nix", "Go"],
        img: "microvisor",
        show_border_passive: false,
      },
      {
        title: "PathFinder",
        description: "Le coach de carrière ultime.",
        github: "https://github.com/xsachax/pathfinder_conuhacks-2025",
        devpost: "https://devpost.com/software/mogcorp",
        tags: ["React", "ThreeJS", "Flask"],
        img: "pathfinder",
        show_border_passive: false,
      },
      {
